...
<div class="col my-5">
        <h2 class="text-center mx-auto fw-bold">KONSULTASI</h2>
</div>
  <div class="row mx-auto animation1" id="menu">
    <div class="col-sm-3 mb-3 mb-sm-0 mx-auto">
      <div class="card">
        <div class="card-body">
          <img src="../img/apoteker_1-removebg-preview.png" alt="" class="img-fluid">
          <h5 class="card-title text-center fw-bold">Muhamad Umar M.Si</h5>
          <p class="card-text fw-medium text-center">(Apoteker & Owner)</p>
          <a href="../menu/konsApoteker1.php" class="btn btn-primary col-12 fw-semibold">Konsultasi disini!</a>
        </div>
      </div>
    </div>
    <div class="col-sm-3 mb-3 mb-sm-0 mx-auto">
      <div class="card">
        <div class="card-body">
          <img src="../img/apoteker2-removebg-preview.png" alt="" class="img-fluid">
          <h5 class="card-title text-center fw-bold">Alisya Syakirah S.farm</h5>
          <p class="card-text fw-medium text-center">Apoteker</p>
          <a href="../menu/konsApoteker2.php" class="btn btn-primary col-12 fw-semibold">Konsultasi disini!</a>
        </div>
      </div>
    </div>
